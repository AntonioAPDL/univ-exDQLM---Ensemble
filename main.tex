...
\subsection{Variational state factor q(alpha\_0:T): Gaussian smoothing with VB pseudo-observations}\label{sec:vb_alpha}
...
\subsection{Variational factor q(v\_t): GIG form}\label{sec:vb_v}
...
\subsection{Variational factor q(s\_t): truncated normal form}\label{sec:vb_s}
...
\subsection{Variational factor q(sigma,gamma) via Laplace--Delta}\label{sec:vb_sigmagamma}
